    ...
    <>
      ...
      >
        ...
        <div className="flex justify-center">
          <div className="text-white pt-40 md:pt-32 lg:pt-16 flex flex-col gap-1">
            <h1 className=" font-silkroad text-7xl lg:text-9xl lg:block sm:text-8xl lg:text-11xl  text-center">
              OFF - ROAD BANDIT
            </h1>
            ...
            <div className="flex justify-center items-center ">
              <h1 className="text-white font-newshape border-2 px-5 py-3 text-2xl lg:text-4xl rounded-2xl tracking-wider mt-28 md:mt-40 lg:mt-32 m-10 md:m-20">
                REGISTER
              </h1>
            </div>
          </div>
        ...
        >
          ...
          <p className=" font-miso text-2xl lg:text-3xl flex flex-col gap-5 text-white mx-5 lg:mx-20 text-justify">
            ...
            tasks of gripping objects and putting them in target zones or just
            picking up a package with a scooper blade and dropping it off at the
            finish line(delivery zone), so that it can complete its respective
            route while overcoming the hurdles in its path.
