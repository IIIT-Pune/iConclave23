      ...
      <div className="text-white text-base sm:text-xl md:text-2xl lg:text-3xl space-y-6  text-justify leading-relaxed px-10 sm:px-20 py-10 lg:py-12 font-miso">
        ...
        <p>
          ...
          >
            ...
            <li>
              Ensure that your Discord account is registered with the same email
              ID you used for your Codeforces account.
            </li>
          </ul>
        </p>
        <p>
        ...
        <p>
          ...
          >
            ...
            <li>
              Make sure you're comfortable coding in your preferred programming
              language.
            </li>
          </ul>
        </p>
        <p>
          ...
          >
            ...
            <li>
              Charge your laptop fully or bring a charger to avoid interruptions
